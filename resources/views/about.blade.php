...
<head>
  ...
  <!-- Document Title -->
  <title>About Us | Sika's Clothing</title>
...
@include('templates/header')
  ...
  <main>
    ...
    <section class="about-us container">
      <div class="mw-930">
        <h2 class="page-title">ABOUT SIKA'S CLOTHING</h2>
      </div>
      <div class="about-us__content pb-5 mb-5">
        <p class="mb-5">
          <img loading="lazy" class="w-100 h-auto d-block" src="{{ asset('/assets/images/about/about-1.jpg') }}" width="1410" height="550" alt="">
        </p>
        <div class="mw-930">
      ...
      <div class="row">
        <div class="col-md-4 text-center mb-5 mb-md-0">
          <div class="service-promotion__icon mb-4">
            <svg width="52" height="52" viewbox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon_shipping"></use></svg>
          </div>
        ...
        <div class="col-md-4 text-center mb-5 mb-md-0">
          <div class="service-promotion__icon mb-4">
            <svg width="53" height="52" viewbox="0 0 53 52" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon_headphone"></use></svg>
          </div>
        ...
        <div class="col-md-4 text-center mb-4 pb-1 mb-md-0">
          <div class="service-promotion__icon mb-4">
            <svg width="52" height="52" viewbox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon_shield"></use></svg>
          </div>
        ...
        <div class="swiper-container js-swiper-slider" data-settings='{
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img loading="lazy" src="{{ asset('/assets/images/brands/brand1.png') }}" width="120" height="20" alt="">
            </div>
            <div class="swiper-slide">
              <img loading="lazy" src="{{ asset('/assets/images/brands/brand2.png') }}" width="87" height="20" alt="">
            </div>
            <div class="swiper-slide">
              <img loading="lazy" src="{{ asset('/assets/images/brands/brand3.png') }}" width="132" height="22" alt="">
            </div>
            <div class="swiper-slide">
              <img loading="lazy" src="{{ asset('/assets/images/brands/brand4.png') }}" width="72" height="21" alt="">
            </div>
            <div class="swiper-slide">
              <img loading="lazy" src="{{ asset('/assets/images/brands/brand5.png') }}" width="123" height="31" alt="">
            </div>
            <div class="swiper-slide">
              <img loading="lazy" src="{{ asset('/assets/images/brands/brand6.png') }}" width="137" height="22" alt="">
            </div>
            <div class="swiper-slide">
              <img loading="lazy" src="{{ asset('/assets/images/brands/brand7.png') }}" width="94" height="21" alt="">
            </div>
          </div><!-- /.swiper-wrapper -->
