                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-floating my-3">
                      <input name="firstname" type="text" class="form-control" id="account_first_name" placeholder="First Name" autocomplete="off">
                      <label for="account_first_name">First Name</label>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-floating my-3">
                      <input name="lastname" autocomplete="off" type="text" class="form-control" id="account_last_name" placeholder="Last Name" required="">
                      <label for="account_last_name">Last Name</label>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-floating my-3">
                      <input name="displayName" autocomplete="off" type="text" class="form-control" id="account_display_name" placeholder="Display Name" required="">
                      <label for="account_display_name">Display Name</label>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-floating my-3">
                      <input name="email" autocomplete="off" type="text" class="form-control" id="account_email" placeholder="Email Address" required="">
                  ...
                  <div class="col-md-12">
                    <div class="form-floating my-3">
                      <input name="password" autocomplete="off" type="password" class="form-control" id="account_current_password" placeholder="Current password" required="">
                      <label for="account_current_password">Current password</label>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-floating my-3">
                      <input name="new_password" autocomplete="off" type="password" class="form-control" id="account_new_password" placeholder="New password" required="">
                      <label for="account_new_password">New password</label>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-floating my-3">
                      <input name="password_confirmation" autocomplete="off" type="password" class="form-control" data-cf-pwd="#account_new_password" id="account_confirm_password" placeholder="Confirm new password" required="">
