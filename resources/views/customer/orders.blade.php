...
<head>
  ...
  <!-- Document Title -->
  <title>Orders | Sik's Clothing</title>
...
<body>
      ...
      <div class="row">
        <div class="col-lg-3">
            <ul class="account-nav">
                ...
                <li><a href="{{ route('orders') }}" class="menu-link menu-link_us-s menu-link_active">Orders</a></li>
  ...
  <script src="{{ asset('/asset/js/plugins/jquery.min.js') }}"></script>
  <script src="{{ asset('/assets/js/plugins/bootstrap.bundle.min.js') }}"></script>
  <script src="{{ asset('/assets/js/plugins/bootstrap-slider.min.js') }}"></script>
  
  <script src="{{ asset('/asset/js/plugins/swiper.min.js') }}"></script>
  <script src="{{ asset('/asset/js/plugins/countdown.js') }}"></script>
