...
<head>
  ...
  <!-- Document Title -->
  <title>Account Signin/Signup | Sika's Clothing</title>
    ...
    <section class="login-register container">
      ...
      <ul class="nav nav-tabs mb-5" id="login_register" role="tablist">
        <li class="nav-item" role="presentation">
          <a class="nav-link nav-link_underscore" id="login-tab"  href="{{ route('login.view') }}"  aria-controls="tab-item-login" aria-selected="true">Login</a>
        </li>
        <li class="nav-item" role="presentation">
          <a class="nav-link nav-link_underscore active" id="register-tab" href="{{ route('register') }}"  aria-controls="tab-item-register" aria-selected="false">Register</a>
        </li>
      </ul>
          ...
          <div class="register-form">
            <form action="{{ route('register') }}" method="post" class="needs-validation" novalidate="">
              ...
              <div class="form-floating mb-3">
                <input autocomplete="off" value="{{ old('username') }}" name="username" type="text" class="form-control form-control_gray @error('username') is-invalid @enderror" id="customerNameRegisterInput" placeholder="Username">
              ...
              <div class="form-floating mb-3">
                <input autocomplete="off" value="{{ old('email') }}" name="email" type="text" class="form-control form-control_gray @error('email') is-invalid @enderror" id="customerEmailRegisterInput" placeholder="Email address *">
              ...
              <div class="form-floating mb-3">
                <input name="password" type="password" class="form-control form-control_gray @error('password') is-invalid @enderror" id="customerPasswodRegisterInput" placeholder="Password *" >
              ...
              <div class="form-floating mb-3">
                <input name="password_confirmation" type="password" class="form-control form-control_gray @error('password_confirmation') is-invalid @enderror" id="customerPasswodRegisterInput" placeholder="Password *" >
                <label for="customerPasswodRegisterInput">Re-enter Password *</label>
                @error('password')
                    <p style="color:red"> {{ $message }} </p>
                @enderror
              </div>
