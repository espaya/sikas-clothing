      ...
      <div class="customer__login">
        ...
        <form action="{{ route('login') }}" method="POST" class="aside-content">
          ...
          <div class="form-floating mb-3">
            <input autocomplete="off" name="email" type="email" class="form-control form-control_gray" id="customerNameEmailInput" placeholder="name@example.com">
          ...
          <div class="form-label-fixed mb-3">
            ...
            <input autocomplete="off" name="password" id="customerPasswordInput" class="form-control form-control_gray" type="password" placeholder="********">
          </div>
